...
int main() {
    ...
    while (window.isOpen()) {
        ...
        //std::cout << global_timer << std::endl;
        //std::cout << global_bounce_time << std::endl;
        ...
        if (game_start == true) {
            ...
            if (intersected1 == false) {
                ...
                if (std::abs(global_timer-global_bounce_time) > 0.03) {
                    ...
                    if (obstacle.getPosition().y > 460) {
                        ...
                        b++;
                        bouncesound();
                        global_bounce_time = global_timer;
                        //timer_start = true;
                    }
